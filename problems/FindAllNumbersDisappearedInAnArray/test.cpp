...
START_TEST(){
    ...
    for (int i = 0; i < sample_size; ++i) {
        ...
        TEST_SEQ_EQUAL(*(sample_output_begin + i), solution.findDisappearedNumbers(*(sample_input_begin + i)));
        // PRINT_SEQ(solution.findDisappearedNumbers(*(sample_input_begin + i)), "");
        /*
