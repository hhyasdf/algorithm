...
START_TEST(){
    ...
    for (int i = 0; i < sample_size; ++i) {
        ...
        TEST_VAL_EQUAL(*(sample_output_begin + i), solution.fibonacci(*(sample_input_begin + i)));
        // TEST_SEQ_EQUAL(*(sample_output_begin + i), solution.fibonacci(*(sample_input_begin + i)));
